...
class PlinderDataModule(LightningDataModule):
    def __init__(self, cfg):
        ...
        self.train_dataset = PlinderGraphDataset(
            ...
            max_entry_validation_clashscore=getattr(cfg.dataset, "max_entry_validation_clashscore", None),
            min_system_num_interactions=getattr(cfg.dataset, "min_system_num_interactions", None),
            min_ligand_num_interactions=getattr(cfg.dataset, "min_ligand_num_interactions", None),
            max_ligand_molecular_weight=getattr(cfg.dataset, "max_ligand_molecular_weight", None),
            require_ligand_is_proper=getattr(cfg.dataset, "require_ligand_is_proper", False),
            exclude_ligand_artifacts=getattr(cfg.dataset, "exclude_ligand_artifacts", False),
            require_system_has_binding_affinity=getattr(cfg.dataset, "require_system_has_binding_affinity", False),
            pharmacophore_profile=getattr(cfg.dataset, "pharmacophore_profile", "plinder"),
            ...
            random_subset=getattr(cfg.dataset, "random_subset", None),
            max_entries=getattr(cfg.dataset, "max_entries", None),
            subset_seed=getattr(cfg.train, "seed", 0),
